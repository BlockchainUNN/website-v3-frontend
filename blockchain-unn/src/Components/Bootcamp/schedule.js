...
const web3_schedule = [
  ...
  },
  {
    ...
    description: "Understanding smart contracts and writing solidity code using Remix.",
  },
  {
    day: "Classes 6-7",
    topic: "Introduction to Lisk",
    description: "Basics of the Lisk blockchain platform and its development environment.",
  },
  {
    day: "Classes 8",
    topic: "Implement an ERC-20 Token",
    description: "Step-by-step guide to creating and deploying an ERC-20 token.",
  },
  {
    day: "Classes 9-10",
  ...
  },
  {
    ...
    description: "Understanding how to deploy contracts and verify them on Etherscan.",
  },
  {
    day: "Classes 12-13",
  ...
  },
  {
    ...
    description: "Using Chainlink to integrate real-world data with smart contracts.",
  },
  {
    day: "Classes 23-24",
  ...
  },
  {
    day: "Classes 28",
    topic: "Security",
    description: "Best practices for securing smart contracts and blockchain applications.",
  },
];
