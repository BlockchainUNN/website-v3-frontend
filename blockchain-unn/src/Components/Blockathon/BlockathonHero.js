...
const BlockathonHero = () => {
  ...
  return (
    <div className="w-screen">
      ...
      <div
        className={`bg-dark-mode flex px-8 py-4 items-center justify-evenly gap-8 w-full h-[120px]`}
      >
        <div
          className={`flex px-8 py-4 items-center justify-evenly gap-8 w-[85%] h-full`}
        >
          ...
          <div className="flex gap-4 items-center ">
            <button
              ...
              className="px-12 py-4 border-white border rounded-md text-white"
            >
              Register Here
            </button>
            <button
              onClick={() => navigate("hackathon/registration")}
              className="px-12 py-4 bg-gray-200 rounded-md text-black"
            >
              Join the Hackathon
            </button>
          </div>
