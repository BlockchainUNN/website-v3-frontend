...
const web2_schedule = [
  ...
  },
  {
    ...
    description: "Tips on LinkedIn profile optimization and pitching effectively.",
  },
  {
    day: "Week 4 Thursday",
  ...
  },
  {
    ...
    description: "trategies for building and managing web3 communities through content.",
  },
  {
    day: "Week 5 Saturday",
  ...
  {
    day: "Week 6 Thursday",
    topic: "Soft Skills for writers: Public Speaking (Understanding the business side of writing)",
    description: "Communication and presentation skills for professional growth.",
  },
  {
    day: "Week 6 Saturday",
    topic: "Linkedin Optimization and Job Pitching",
    ...
    <div className="w-full px-2 md:px-[6rem] flex flex-col items-center -mt-12">
      <div className="top-border w-full h-fit md:h-[251px] rounded-xl bg-dark-mode-4 flex flex-col-reverse items-end px-8 py-6 rotate-180">
        ...
        <p className="text-white -rotate-180 mb-2 text-[12px] md:text-auto">
          The bootcam will have focus on 3 stacks in Content and Marketing, <span className="font-semibold">(Content, Social media Management and Community Management)</span>.
        </p>
