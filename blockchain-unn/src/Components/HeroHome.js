...
const HeroHome = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center">
            <BlockathonHeader />
            <div className={`${theme ? "bg-dark-mode " : "bg-transparent"} flex flex-col md:py-4 items-center w-full font-raleway `}>
            <Navbar />
                <div className="text-center flex flex-col items-center w-[92%] md:w-[80%] mx-auto">
                    <h1 className="text-green-900 font-[900] text-[50px] md:text-[150px] ">
                        BLOCKCHAIN
                    </h1>
                    <div className="flex items-center gap-4 ">
                        <h1 className="text-green-900 font-extrabold text-[50px] md:text-[150px]">
                            UNN
                        </h1>
                        <div className="flex items-center justify-center bg-gradient-to-r from-green-950 to-green-500 p-2 md:p-4 w-[80%] md:[50%]">
                            <p className="text-[12px] md:text-[50px] text-center w-full text-white border-t border-b border-white p-2 md:p-4">
            ...
            <div className={` ${theme ? 'text-white' : 'text-black' } w-[80%] md:w-[50%] text-center mt-2 md:mt-0 mb-8` }>
            ...
            <div className={`${theme ? "bg-dark-mode border-t border-b border-gray-600" : "bg-white border-t border-b border-gray-500"} flex gap-1 md:gap-2 items-center justify-center w-full p-4 md:px-16  md:py-8 text-[14px] md:text-[60px] mb-2 md:mb-4 `}>
            ...
            <div className={`${theme ? 'bg-dark-mode text-white border-t border-b border-gray-600' : 'bg-white border-t border-b border-gray-500 text-black '} flex md:flex-row flex-col items-center justify-center gap-8 w-full h-[fit-content] px-6 md:px-24 py-4`}>
                <div className="flex flex-col gap-4 items-start p-4 border border-green-500 rounded-md w-full md:w-[40%] mt-6">
                    ...
                    <h2 className="text-[80px] md:text-[100px] font-bold mb-0">
                        4000K+
                    </h2>
                        ...
                        <div className="relative flex flex-col gap-4 bg-black rounded-md py-4 px-2 w-[95%] h-full">
                            ...
                            <div className="flex flex-row gap-4 items-center justify-evenly">
                                ...
                                <div className="flex flex-col items-start bg-[#02641C] text-[#2CE85E] px-4 md:px-8 md:py-4 py-2  rounded-md w-[70%] md:w-[50%] h-[140px]">
                                    <h3 className="font-semibold flex text-[0.6rem] gap-1 md:text[1.rem] items-center md:gap-2"><span className="text-[1rem] md:text-[30px]">4</span>Active Sub-Communities <FaPeopleCarry className="hidden md:flex" /></h3>
